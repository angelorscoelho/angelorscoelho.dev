...
import { GitHubIcon, LinkedInIcon, ExternalLinkIcon, EmailIcon } from './components/Icon';
    ...
    <div className="relative bg-slate-900 selection:bg-teal-300 selection:text-teal-900">
      ...
      <div className="mx-auto min-h-screen max-w-screen-xl px-6 py-12 font-sans md:px-12 md:py-20 lg:px-24 lg:py-0 relative z-40">
        <div className="lg:flex lg:justify-between lg:gap-12">
          ...
          {/* LEFT COLUMN: Header / Nav (Slightly narrower to give text room) */}
          <header className="lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-[42%] lg:flex-col lg:justify-between lg:py-24">
            ...
            <ul className="ml-1 mt-8 flex items-center" aria-label="Social media">
              ...
              <li className="mr-5 text-xs">
                <a className="block hover:text-slate-200" href={RESUME.socials.email} target="_blank" rel="noreferrer">
          ...
          {/* RIGHT COLUMN: Content (Wider to avoid crunched text) */}
          <main id="content" className="pt-24 lg:w-[58%] lg:py-24">
