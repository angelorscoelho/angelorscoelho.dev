...
export const SpotlightCard: React.FC<SpotlightCardProps> = ({ children, className = '' }) => {
  ...
  return (
    ...
    >
      ...
      {/* Always-visible spotlight; opacity no longer tied to hover state */}
      <div 
        className="pointer-events-none absolute -inset-px rounded-lg opacity-100 transition duration-300"
        style={{
      ...
      {/* Border Highlight */}
      <div 
        className="pointer-events-none absolute -inset-px rounded-lg border border-teal-300/30 opacity-100 transition duration-300"
        style={{
